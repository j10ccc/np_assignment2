...
int main(int argc, char *argv[]) {
  ...
  /*
     Prepare to setup a reoccurring event every 10s. If it_interval, or it_value
  ...
  */
  ...
  /* Regiter a callback function, associated with the SIGALRM signal, which will
   * be raised when the alarm goes of */
